...
public class SDCardHelper {
    ...
    public static boolean saveFileToSDCardPublicDir(byte[] data, String type, String fileName) {
        if (isSDCardMounted()) {
            ...
            return saveDataToFile(data, dir, fileName);
        }
        return false;
    }

    public static boolean saveDataToFile(byte[] data, File dir, String fileName) {
    ...
    public static boolean saveFileToSDCardCustomDir(byte[] data, String dir, String fileName) {
        ...
        if (isSDCardMounted()) {
            ...
            return saveDataToFile(data, file, fileName);
        }
        return false;
    }
     ...
     *
     * @param data
     * @param type     为空时直接保存在/sdcard/Android/data/pkgName/files/下
     * @param fileName
     * @param context
     * @return
     */
